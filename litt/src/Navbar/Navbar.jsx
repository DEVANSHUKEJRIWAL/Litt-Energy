    ...
    return (
      <>
        ...
        <div id="page-container" className="flex flex-col mx-auto w-full min-h-screen min-w-[320px] bg-gray-100 dark:text-gray-100 dark:bg-gray-900">
            ...
            <div className="container xl:max-w-7xl mx-auto px-4 lg:px-8">
              <div className="flex justify-between py-4">
                ...
                <div className="flex items-center space-x-2 lg:space-x-5">
                  ...
                  <nav className="hidden lg:flex items-center space-x-2">
                    <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-rose-600 border border-rose-100 bg-rose-50 dark:text-white dark:bg-gray-700 dark:border-transparent">
                    ...
                    <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-rose-600 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
              ...
              >
                <nav className="flex flex-col space-y-2 py-4 border-t dark:border-gray-700">
                  <a href="#" className="group text-sm font-semibold flex items-center space-x-2 px-3 py-2 rounded-lg text-rose-600 border border-rose-50 bg-rose-50 dark:text-white dark:bg-gray-700/75 dark:border-transparent">
                    <svg className="hi-mini hi-home inline-block w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fillRule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clipRule="evenodd" /></svg>
                    <span>Dashboard</span>
                  </a>
                  <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-rose-600 hover:bg-rose-50 active:border-rose-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
          ...
          {/* Page Content */}
          <main id="page-content" className="text-gray-600 body-font flex flex-auto flex-col max-w-full">
            {/* Page Section */}
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap -m-4">
                    <div class="p-4 md:w-1/3">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://cdn.dribbble.com/users/224485/screenshots/1953078/media/c80128f4e2eaa65e2e48323ac3ee4336.gif" alt="blog"/>
                            <div className="p-6">
                               
                                <h1 className="title-font text-lg font-medium text-lime-300 mb-3">FACTORY</h1>
                                <p className="text-gray-300 leading-relaxed mb-3">We're forging a partnership with a factory to utilize their vacant space for solar panels, promoting renewable energy and sustainability. Harnessing this potential, we aim to generate clean power and reduce our carbon footprint for a brighter and eco-conscious tomorrow.</p>
                            </div>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/3">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://i.pinimg.com/originals/a2/70/d2/a270d270d5ca184422cf980475b99e24.gif" alt="blog" />
                            <div className="p-6">
                               
                                <h1 className="title-font text-lg font-medium text-lime-300  mb-3">Platform</h1>
                                <p className="text-gray-300 leading-relaxed mb-3">Invest with us as a buyer and access real-time stats on your solar panel investments. Stay informed about their performance effortlessly through our user-friendly interface. Transparency is our priority, and we'll provide regular reports on the profits generated. Join the sustainable energy revolution, make informed investment decisions, and create a greener future together. Be part of the clean energy movement and reap the rewards of a sustainable tomorrow. Invest now and embrace a brighter, eco-conscious future.</p>
                    ...
                    <div className="p-4 md:w-1/3">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_images/E02724065_Google_GMP_DV360_PG_POS_asset_Mar22_v03.gif" alt="blog" />
                            <div className="p-6">
                                <h1 className="title-font text-lg font-medium text-lime-300 mb-3">Residential Buyer</h1>
                                <p className="text-gray-300  leading-relaxed mb-3">Invest in our green energy farms and enjoy a world of benefits! Earn valuable credits that convert into tokens, making energy bill payments hassle-free. Join our mission to promote renewable energy and reap the rewards of sustainable investments. Contribute to a greener future and watch your credits grow, effortlessly offsetting your energy expenses. Embrace a sustainable and rewarding energy journey with us. Invest today!</p>
